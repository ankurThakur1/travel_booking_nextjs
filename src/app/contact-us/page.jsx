          ...
          <div className="text-white flex flex-col justify-center space-y-6">
            <div className="border rounded-3xl border-black bg-[#16243d]">
              ...
              <div className="flex flex-col gap-4 py-6">
                <div className="flex gap-8 border-b border-gray-600 px-20">
                  <h3 className="w-14 h-14 rounded-full flex justify-center items-center text-xl sm:text-xl md:text-xl lg:text-2xl font-bold text-[#ff9d3d] bg-[#2d3a50]"><FaPhoneFlip /></h3>
                ...
                <div className="flex gap-8 border-b border-gray-600 px-20">
                  <h3 className="w-14 h-14 rounded-full   flex justify-center items-center text-xl sm:text-xl md:text-xl lg:text-2xl font-bold text-[#ff9d3d] bg-[#2d3a50]"><MdEmail /></h3>
                  <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-8  px-20">
                  <h3 className="w-14 h-14 rounded-full   flex justify-center items-center text-xl sm:text-xl md:text-xl lg:text-2xl font-bold text-[#ff9d3d] bg-[#2d3a50]"><FaLocationDot /></h3>
                  <div className="flex flex-col gap-2">
